...
<title><?= Settings::get('site_name') ? Settings::get('site_name').' | ' : '' ?> <?= lang('ionize_admin_title') ?></title>
		...
		<div id="desktopTitlebarWrapper">
			<div id="desktopTitlebar">
				...
				<div id="desktopNavbar">
					<ul>
						<li><a id="dashboardLink"><?= lang('ionize_menu_dashboard') ?></a></li>
						...
						<li><a class="returnFalse" href=""><?= lang('ionize_menu_tools') ?></a>
							<ul>
								<li><a id="googleAnalyticsLink" href="https://www.google.com/analytics/reporting/login" target="_blank"><?= lang('ionize_menu_google_analytics') ?></a></li>
							</ul>
						</li>
